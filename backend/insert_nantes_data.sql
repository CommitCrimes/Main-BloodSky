...
INSERT INTO hospital (hospital_id, hospital_name, hospital_city, hospital_postal, hospital_adress, hospital_latitude, hospital_longitude) VALUES
...
ON CONFLICT (hospital_id) DO UPDATE SET
  hospital_latitude = EXCLUDED.hospital_latitude,
  hospital_longitude = EXCLUDED.hospital_longitude;
...
SELECT 'HÔPITAUX' as type, hospital_id as id, hospital_name as name, hospital_city as city, hospital_adress as address, hospital_postal as postal, hospital_latitude as lat, hospital_longitude as lng 
FROM hospital 
