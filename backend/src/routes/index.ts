      ...
      components: {
        securitySchemes: {
          BearerAuth: {
            ...
            bearerFormat: "JWT",
            description:
              "JWT token for authentication. Use the token received from login endpoint.",
          },
        },
        schemas: {
          User: {
      ...
      paths: {
        ...
        "/superadmin/admins": {
          get: {
            ...
            security: [{ BearerAuth: [] }],
            description:
              "Retrieve all administrators (hospitals and donation centers). Requires super admin authentication.",
            responses: {
              "200": {
                  ...
                  "application/json": {
                    schema: {
                      ...
                      properties: {
                        message: {
                          type: "string",
                          example: "Admin supprimé avec succès",
                        },
                      },
                    },
                  },
        ...
        "/superadmin/users": {
          get: {
            ...
            security: [{ BearerAuth: [] }],
            description:
              "Retrieve all users in the system. Requires super admin authentication.",
            responses: {
              "200": {
        ...
        "/superadmin/deliveries": {
          get: {
            ...
            security: [{ BearerAuth: [] }],
            description:
              "Retrieve delivery history with optional filters. Requires super admin authentication.",
            parameters: [
              {
                name: "entityType",
                in: "query",
        ...
        "/superadmin/statistics": {
          get: {
            ...
            security: [{ BearerAuth: [] }],
            description:
              "Retrieve global system statistics. Requires super admin authentication.",
            responses: {
              "200": {
